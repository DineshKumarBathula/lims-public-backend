// const CEMENT_SETTING_TIME = "CEMENT_SETTING_TIME";
// const CEMENT_COMPRESSIVE_STRENGTH = "CEMENT_COMPRESSIVE_STRENGTH";

// const cementNablMech = (parsedJdata) => {
//   const getRow = (reportData) => {
//     const { key, value, requirements, remarks } = reportData;
...
//   const getCementCompressiveStrength = (reportData) => {
//     const dummy = reportData.map((each) => {
//       const { key, val, requirements, remarks } = each;
//       return [
//         {
//           text: key,
//           fontSize: 9,
...
//       if (paramName === CEMENT_SETTING_TIME) {
//         return [...getRow(reportData[0]), ...getRow(reportData[1])];
//       } else if (paramName === CEMENT_COMPRESSIVE_STRENGTH) {
//         return getCementCompressiveStrength(reportData);
//       } else return getRow(reportData[0]);
//     }),
//   ];
